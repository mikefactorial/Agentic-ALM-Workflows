...
# Import the client classes (co-located in the same scripts folder)
. (Join-Path $PSScriptRoot "DataverseApiClient.ps1")
. (Join-Path $PSScriptRoot "PowerPlatformClient.ps1")
